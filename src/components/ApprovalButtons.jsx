...
const ApprovalButtons = ({ onApprove, onReject, loading, isRevision = false }) => {
  ...
  return (
    <div className="space-y-4">
      {showFeedback && (
        <div className="feedback-dialog feedback-dialog-enter p-6">
          <div className="feedback-dialog-content">
            <h3 className="text-lg font-semibold mb-4 font-spaceg feedback-title">
              Request Changes
            </h3>
            
            <div className="space-y-4">
              <div>
                <label htmlFor="feedback" className="block text-sm font-medium mb-2 font-inter feedback-label">
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full px-3 py-3 rounded-lg font-inter feedback-textarea resize-none"
              ...
              <div className="flex gap-3 justify-end">
                <button
                  ...
                  disabled={loading}
                  className="px-6 py-2 text-sm font-medium rounded-lg font-inter feedback-cancel-btn"
                >
                  Cancel
                </button>
                <button
                  ...
                  className={`px-6 py-2 text-sm font-medium rounded-lg font-inter feedback-submit-btn ${
